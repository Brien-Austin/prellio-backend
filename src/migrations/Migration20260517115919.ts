...
export class Migration20260517115919 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table "degree" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "name" text not null, constraint "degree_pkey" primary key ("id"));`);
    this.addSql(`alter table "degree" add constraint "degree_name_unique" unique ("name");`);

    this.addSql(`create table "department" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "name" text not null, constraint "department_pkey" primary key ("id"));`);
    this.addSql(`alter table "department" add constraint "department_name_unique" unique ("name");`);

    this.addSql(`create table "designation" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "name" text not null, constraint "designation_pkey" primary key ("id"));`);
    this.addSql(`alter table "designation" add constraint "designation_name_unique" unique ("name");`);

    this.addSql(`create table "learner_type" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "name" text not null, constraint "learner_type_pkey" primary key ("id"));`);
    this.addSql(`alter table "learner_type" add constraint "learner_type_name_unique" unique ("name");`);

    this.addSql(`create table "question" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "type" text check ("type" in ('MCQ', 'FILL_UP')) not null, "question" text not null, "explanation" text null, "difficulty" text check ("difficulty" in ('EASY', 'MEDIUM', 'HARD')) not null, constraint "question_pkey" primary key ("id"));`);

    this.addSql(`create table "mcq_question" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "question_id" uuid not null, constraint "mcq_question_pkey" primary key ("id"));`);
    this.addSql(`alter table "mcq_question" add constraint "mcq_question_question_id_unique" unique ("question_id");`);

    this.addSql(`create table "mcq_option" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "mcq_question_id" uuid not null, "text" text not null, "type" text check ("type" in ('CORRECT', 'WRONG')) not null, constraint "mcq_option_pkey" primary key ("id"));`);

    this.addSql(`create table "fill_up_question" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "question_id" uuid not null, constraint "fill_up_question_pkey" primary key ("id"));`);
    this.addSql(`alter table "fill_up_question" add constraint "fill_up_question_question_id_unique" unique ("question_id");`);

    this.addSql(`create table "fill_up_answer" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "fill_up_question_id" uuid not null, "answer" text not null, constraint "fill_up_answer_pkey" primary key ("id"));`);

    this.addSql(`create table "school_board" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "name" text not null, constraint "school_board_pkey" primary key ("id"));`);
    this.addSql(`alter table "school_board" add constraint "school_board_name_unique" unique ("name");`);

    this.addSql(`create table "user" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "email" text not null, "password" text not null, "name" text null, "refresh_token" text null, "learner_type_id" uuid null, constraint "user_pkey" primary key ("id"));`);
    this.addSql(`alter table "user" add constraint "user_email_unique" unique ("email");`);

    this.addSql(`create table "session" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "user_id" uuid not null, "hashed_refresh_token" text null, "expires_at" timestamptz not null, "revoked_at" timestamptz null, "device_type" text check ("device_type" in ('WEB', 'ANDROID', 'IOS', 'API_CLIENT', 'UNKNOWN')) not null default 'UNKNOWN', "user_agent" text null, constraint "session_pkey" primary key ("id"));`);

    this.addSql(`create table "school_profile" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "user_id" uuid not null, "school_name" text null, "class_name" text null, "school_board_id" uuid null, constraint "school_profile_pkey" primary key ("id"));`);
    this.addSql(`alter table "school_profile" add constraint "school_profile_user_id_unique" unique ("user_id");`);

    this.addSql(`create table "college_profile" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "user_id" uuid not null, "college_name" text null, "degree_id" uuid null, "department_id" uuid null, "year_of_study" int null, constraint "college_profile_pkey" primary key ("id"));`);
    this.addSql(`alter table "college_profile" add constraint "college_profile_user_id_unique" unique ("user_id");`);

    this.addSql(`create table "working_professional_profile" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "user_id" uuid not null, "company_name" text null, "designation_id" uuid null, "department_id" uuid null, "years_of_experience" int null, constraint "working_professional_profile_pkey" primary key ("id"));`);
    this.addSql(`alter table "working_professional_profile" add constraint "working_professional_profile_user_id_unique" unique ("user_id");`);

    this.addSql(`alter table "mcq_question" add constraint "mcq_question_question_id_foreign" foreign key ("question_id") references "question" ("id") on update cascade;`);

    this.addSql(`alter table "mcq_option" add constraint "mcq_option_mcq_question_id_foreign" foreign key ("mcq_question_id") references "mcq_question" ("id") on update cascade;`);

    this.addSql(`alter table "fill_up_question" add constraint "fill_up_question_question_id_foreign" foreign key ("question_id") references "question" ("id") on update cascade;`);

    this.addSql(`alter table "fill_up_answer" add constraint "fill_up_answer_fill_up_question_id_foreign" foreign key ("fill_up_question_id") references "fill_up_question" ("id") on update cascade;`);

    this.addSql(`alter table "user" add constraint "user_learner_type_id_foreign" foreign key ("learner_type_id") references "learner_type" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table "school_profile" add constraint "school_profile_user_id_foreign" foreign key ("user_id") references "user" ("id") on update cascade;`);
    this.addSql(`alter table "school_profile" add constraint "school_profile_school_board_id_foreign" foreign key ("school_board_id") references "school_board" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table "college_profile" add constraint "college_profile_user_id_foreign" foreign key ("user_id") references "user" ("id") on update cascade;`);
    this.addSql(`alter table "college_profile" add constraint "college_profile_degree_id_foreign" foreign key ("degree_id") references "degree" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "college_profile" add constraint "college_profile_department_id_foreign" foreign key ("department_id") references "department" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table "working_professional_profile" add constraint "working_professional_profile_user_id_foreign" foreign key ("user_id") references "user" ("id") on update cascade;`);
    this.addSql(`alter table "working_professional_profile" add constraint "working_professional_profile_designation_id_foreign" foreign key ("designation_id") references "designation" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "working_professional_profile" add constraint "working_professional_profile_department_id_foreign" foreign key ("department_id") references "department" ("id") on update cascade on delete set null;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create type "DeviceType" as enum ('WEB', 'ANDROID', 'IOS', 'UNKNOWN', 'API_CLIENT');`);
    this.addSql(`create type "DifficultyLevel" as enum ('EASY', 'MEDIUM', 'HARD');`);
    this.addSql(`create type "McqOptionType" as enum ('CORRECT', 'WRONG');`);
    this.addSql(`create type "QuestionType" as enum ('MCQ', 'FILL_UP');`);
